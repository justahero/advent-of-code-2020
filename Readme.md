...
The main purpose is to learn more about the Rust language, not necessarily to come up with the "best", most efficient or elegant solution. That is for another time.
